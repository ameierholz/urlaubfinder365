  ...
  if (loading) {
    return (
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-gray-900">Meine Reisen</h2>
    ...
    return (
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
          <Heart className="w-5 h-5 text-rose-500" /> Meine Reisen
        </h2>
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-12 text-center">
          ...
          <h3 className="font-bold text-gray-700 mb-2">Noch keine Reisen gespeichert</h3>
          <p className="text-gray-400 text-sm mb-6">
            Klicke beim Durchstöbern auf das ❤ bei einem Angebot, um es hier zu speichern.
          </p>
          <a href="/" className="inline-block bg-[#00838F] text-white text-sm font-semibold px-6 py-2.5 rounded-full hover:bg-[#006E7A] transition-colors">
            Angebote entdecken
          </a>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <ul className="mt-2 space-y-1.5 text-sm text-gray-500">
          <li className="flex items-start gap-2"><span className="shrink-0 mt-0.5">🔍</span><span>Stöbere auf der <a href="/" className="text-[#00838F] underline hover:text-[#006E7A]">Startseite</a> oder bei den <a href="/urlaubsziele/" className="text-[#00838F] underline hover:text-[#006E7A]">Urlaubszielen</a> nach Pauschalreisen</span></li>
          <li className="flex items-start gap-2"><span className="shrink-0 mt-0.5">❤️</span><span>Klicke beim Angebot auf das <strong>Herz-Icon</strong> – es wird sofort hier in deiner Merkliste gespeichert</span></li>
          <li className="flex items-start gap-2"><span className="shrink-0 mt-0.5">📋</span><span>Vergleiche Hotel, Preis, Reisedaten und Bewertung aller gemerkten Reisen auf einen Blick</span></li>
          <li className="flex items-start gap-2"><span className="shrink-0 mt-0.5">✈️</span><span>Klicke <strong>„Jetzt buchen"</strong> um direkt zum Buchungsformular des Anbieters zu gelangen</span></li>
          <li className="flex items-start gap-2"><span className="shrink-0 mt-0.5">🗑️</span><span>Nicht mehr interessant? Papierkorb-Icon klicken, um ein Angebot zu entfernen</span></li>
        </ul>
      </div>
