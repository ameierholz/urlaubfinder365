...
const REISEARTEN = [
  ...
  },
  {
    emoji: "📅",
    label: "Frühbucher",
    tagline: "Früh buchen – bis zu 30 % günstiger",
    desc: "Wer 6–12 Monate im Voraus bucht, sichert sich die beste Auswahl und die günstigsten Preise der Saison.",
    badge: "Bis −30 %",
    badgeColor: "bg-sky-500 text-white",
    highlights: ["Beste Zimmerauswahl", "Günstigste Saisonpreise", "Oft kostenloses Storno"],
