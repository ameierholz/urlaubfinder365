  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-4">
        <p className="text-yellow-600 text-sm font-bold uppercase tracking-widest mb-2">Beliebte Reiseziele</p>
        ...
        <DestinationGrid destinations={DESTINATIONS} accentColor="#ca8a04" carouselLabel="Weitere Luxus Reiseziele" />
      </div>
