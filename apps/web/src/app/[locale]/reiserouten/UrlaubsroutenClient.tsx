...
const DEMO_ROUTES: PublicRoute[] = [
  {
    ...
    cloneCount: 23, coverImageUrl: "https://images.unsplash.com/photo-1686808191914-5df77394ec3a?w=600&q=80&auto=format", createdAt: "2025-09-01T10:00:00Z",
  },
  {
    ...
    cloneCount: 45, coverImageUrl: "https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=600&q=80&auto=format", createdAt: "2025-08-15T14:00:00Z",
  },
  {
    ...
    cloneCount: 31, coverImageUrl: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=600&q=80&auto=format", createdAt: "2025-07-20T09:00:00Z",
  },
  {
    ...
    cloneCount: 67, coverImageUrl: "https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=600&q=80&auto=format", createdAt: "2025-10-05T16:00:00Z",
  },
  {
    ...
    cloneCount: 18, coverImageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=600&q=80&auto=format", createdAt: "2025-11-10T11:00:00Z",
  },
  {
    ...
    cloneCount: 52, coverImageUrl: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=600&q=80&auto=format", createdAt: "2025-06-20T08:30:00Z",
  },
];
...
export default function UrlaubsroutenClient() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-bold text-gray-900">Urlaubsrouten entdecken & klonen</h2>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
            ...
            <p className="text-sm text-gray-400 mb-6">Teile deine Urlaubsplanung im Dashboard, um hier zu erscheinen.</p>
            {userId && (
