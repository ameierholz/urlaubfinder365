...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=1200&h=630&q=80&auto=format",
        width: 1200,
        height: 630,
...
const DESTINATIONS: DestinationCard[] = [
  { name:"Balearen", flag:"🇪🇸", image:"https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=600&q=80&auto=format", teaser:"Die Balearen sind Europas Inbegriff für exklusiven Adults Only Urlaub: Mallorca überzeugt mit romantischen Cliff-Hotels und privaten Infinity-Pools, Ibiza mit stilvollem Boutique-Ambiente und Menorca mit unberührter Naturlandschaft. Keine Kinder, nur Ruhe, Genuss und unvergessliche Zweisamkeit – an einem der schönsten Meere der Welt.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=100000&keywords=ado" },
  { name:"Türkei", flag:"🇹🇷", image:"https://images.unsplash.com/photo-1686808191914-5df77394ec3a?w=600&q=80&auto=format", teaser:"Antalya & Bodrum: stilvolle Erwachsenenhotels direkt am türkisblauen Mittelmeer.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=724&keywords=ado" },
  { name:"Griech. Inseln", flag:"🇬🇷", image:"https://images.unsplash.com/photo-1555993539-1732b0258235?w=600&q=80&auto=format", teaser:"Korfu, Kos & Mykonos: entspannte Strandatmosphäre auf den schönsten Inseln.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=100002&keywords=ado" },
  ...
  { name:"Kanaren", flag:"🇪🇸", image:"https://images.unsplash.com/photo-1519046904884-53103b34b206?w=600&q=80&auto=format", teaser:"Lanzarote & Teneriffa: Adults Only Hotels mit Meerblick – das ganze Jahr.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=851&keywords=ado" },
  { name:"Ägypten", flag:"🇪🇬", image:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80&auto=format", teaser:"Hurghada & Marsa Alam: luxuriöse Resorts am kristallklaren Roten Meer.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=651&keywords=ado" },
  { name:"Dubai & VAE", flag:"🇦🇪", image:"https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&q=80&auto=format", teaser:"Exklusive Strandhotels und Rooftop-Pools auf höchstem Niveau.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=650&keywords=ado" },
  { name:"Thailand", flag:"🇹🇭", image:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80&auto=format", teaser:"Phuket & Koh Samui: romantische Bungalows und Spa-Resorts im Tropenparadies.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=100220&keywords=ado" },
  { name:"Karibik", flag:"🌴", image:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80&auto=format", teaser:"Kuba, Jamaika & Mexiko: Adults Only Strandresorts mit All-Inclusive-Komfort.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=100017&keywords=ado" },
  ...
  { name:"Portugal", flag:"🇵🇹", image:"https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=600&q=80&auto=format", teaser:"Algarve: moderne Adults Only Hotels an den schönsten Klippen Europas.", deeplink:"https://b2b.specials.de/index/jump/119/2780/993243/?from=14&to=42&duration=7-7&adults=2&category=3&minRecommrate=60&regionId=725&keywords=ado" },
];
...
const FAQ = [
  ...
  {
    q: "In welchen Urlaubszielen gibt es die besten Adults Only Hotels?",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-14 pt-32">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight mb-4 drop-shadow-lg">
            Adults Only Urlaub {YEAR} günstig buchen<br />
            <span className="text-rose-200">Romantik, Ruhe &amp; pure Entspannung</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-4">
        <p className="text-rose-600 text-sm font-bold uppercase tracking-widest mb-2">Beliebte Urlaubsziele</p>
        ...
        <DestinationGrid destinations={DESTINATIONS} accentColor="#e11d48" carouselLabel="Weitere Adults Only Urlaubsziele" />
      </div>
    ...
    <SeoTextBlocks pagePath="/urlaubsthemen/adults-only" />
    </div>
  );
}
