  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ThemeDestinationLinks
        eyebrow="Beliebte Senioren-Reiseziele"
        heading="Seniorenreisen Reiseziele im Überblick"
        accentColor="#2563eb"
        destinations={[
          { slug: "mallorca", label: "Senioren Mallorca" },
          { slug: "teneriffa", label: "Senioren Teneriffa" },
          { slug: "gran-canaria", label: "Senioren Gran Canaria" },
          { slug: "fuerteventura", label: "Senioren Fuerteventura" },
          { slug: "lanzarote", label: "Senioren Lanzarote" },
          { slug: "kreta", label: "Senioren Kreta" },
          { slug: "rhodos", label: "Senioren Rhodos" },
          { slug: "antalya", label: "Senioren Antalya" },
          { slug: "side", label: "Senioren Side" },
          { slug: "lissabon", label: "Senioren Lissabon" },
          { slug: "kos", label: "Senioren Kos" },
          { slug: "marrakesch", label: "Senioren Marrakesch" },
        ]}
      />
    ...
    <SeoTextBlocks pagePath="/urlaubsthemen/seniorenreisen" />
    </div>
  );
}
