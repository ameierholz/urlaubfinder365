...
interface DestinationData {
  ...
  slug: string;
  countryCode: string;
  besteMonateIdx: number[]; // 0 = Januar
  typen: Typ[];
  budgetStufe: 1 | 2 | 3; // 1 = günstig, 2 = mittel, 3 = gehoben
  highlight: string;
  temp: number[]; // Durchschnittstemp je Monat
}

const DESTINATIONS: DestinationData[] = [
  {
    name: "Mallorca", slug: "mallorca", countryCode: "es",
    besteMonateIdx: [3, 4, 5, 8, 9], typen: ["strand", "kultur", "stadt"],
    budgetStufe: 2, highlight: "Traumstrände & Tramuntana-Gebirge",
    temp: [14,15,17,19,22,26,29,29,26,22,17,15],
  },
  {
    name: "Antalya", slug: "antalya", countryCode: "tr",
    besteMonateIdx: [3, 4, 5, 6, 7, 8, 9], typen: ["strand", "kultur"],
    budgetStufe: 1, highlight: "Lykische Küste & All-Inclusive-Hotels",
    temp: [10,11,14,18,23,28,33,33,29,23,17,12],
  },
  {
    name: "Bali", slug: "bali", countryCode: "id",
    besteMonateIdx: [4, 5, 6, 7, 8, 9], typen: ["strand", "kultur", "abenteuer"],
    budgetStufe: 1, highlight: "Reisterrassen, Tempel & Surfer-Strände",
    temp: [27,27,28,28,27,26,26,26,27,27,27,27],
  },
  {
    name: "Kreta", slug: "kreta", countryCode: "gr",
    besteMonateIdx: [4, 5, 6, 7, 8, 9], typen: ["strand", "kultur"],
    budgetStufe: 2, highlight: "Minoische Kultur & herrliche Strände",
    temp: [12,12,14,18,23,27,29,29,26,21,17,13],
  },
  {
    name: "Thailand (Phuket)", slug: "phuket", countryCode: "th",
    besteMonateIdx: [0, 1, 2, 3, 10, 11], typen: ["strand", "abenteuer", "kultur"],
    budgetStufe: 1, highlight: "Smaragdgrüne Buchten & lebhaftes Nachtleben",
    temp: [27,28,28,29,28,27,27,27,27,27,27,27],
  },
  {
    name: "Dubai", slug: "dubai", countryCode: "ae",
    besteMonateIdx: [0, 1, 2, 3, 10, 11], typen: ["strand", "stadt", "abenteuer"],
    budgetStufe: 3, highlight: "Futuristische Skyline & Wüsten-Abenteuer",
    temp: [19,20,23,27,32,34,36,37,34,31,26,21],
  },
  {
    name: "Malediven", slug: "malediven", countryCode: "mv",
    besteMonateIdx: [0, 1, 2, 3, 4], typen: ["strand"],
    budgetStufe: 3, highlight: "Überwasser-Bungalows & Korallenriffe",
    temp: [28,28,29,30,29,28,28,28,28,28,28,28],
  },
  {
    name: "Kroatien (Dubrovnik)", slug: "dubrovnik", countryCode: "hr",
    besteMonateIdx: [4, 5, 6, 7, 8, 9], typen: ["strand", "kultur", "stadt"],
    budgetStufe: 2, highlight: "Mittelalterliche Altstadt & Adriatisches Meer",
    temp: [9,10,12,16,20,24,27,27,23,18,14,10],
  },
  {
    name: "Lanzarote", slug: "lanzarote", countryCode: "es",
    besteMonateIdx: [0, 1, 2, 3, 10, 11], typen: ["strand", "abenteuer"],
    budgetStufe: 2, highlight: "Vulkanlandschaften & ganzjährig Sonne",
    temp: [18,18,19,20,21,23,25,26,25,23,21,19],
  },
  {
    name: "Portugal (Algarve)", slug: "algarve", countryCode: "pt",
    besteMonateIdx: [4, 5, 6, 7, 8, 9], typen: ["strand", "kultur"],
    budgetStufe: 2, highlight: "Goldene Felsenküste & Surferwellen",
    temp: [13,14,16,17,19,22,25,26,23,20,16,13],
  },
  {
    name: "Marokko (Marrakesch)", slug: "marrakesch", countryCode: "ma",
    besteMonateIdx: [2, 3, 4, 9, 10], typen: ["kultur", "abenteuer", "stadt"],
    budgetStufe: 1, highlight: "Djemaa el-Fna & Saharawüste",
    temp: [12,14,17,20,23,27,33,32,27,22,16,13],
  },
  {
    name: "Japan (Tokio)", slug: "tokio", countryCode: "jp",
    besteMonateIdx: [2, 3, 4, 9, 10], typen: ["kultur", "stadt", "abenteuer"],
    budgetStufe: 3, highlight: "Kirschblüten, Anime-Kultur & Tradition",
    temp: [5,6,10,14,19,22,26,27,24,19,14,7],
  },
  {
    name: "Teneriffa", slug: "teneriffa", countryCode: "es",
    besteMonateIdx: [0, 1, 2, 3, 10, 11], typen: ["strand", "abenteuer"],
    budgetStufe: 2, highlight: "Teide-Nationalpark & ewiger Frühling",
    temp: [18,18,19,20,21,24,26,27,26,23,21,19],
  },
  {
    name: "Hurghada", slug: "hurghada", countryCode: "eg",
    besteMonateIdx: [0, 1, 2, 3, 9, 10, 11], typen: ["strand", "kultur"],
    budgetStufe: 1, highlight: "Rotes Meer & Tauchen im Korallenriff",
    temp: [18,19,21,25,30,33,35,35,32,28,23,19],
  },
  {
    name: "Dominik. Republik", slug: "dominikanische-republik", countryCode: "do",
    besteMonateIdx: [0, 1, 2, 3, 4], typen: ["strand", "abenteuer"],
    budgetStufe: 2, highlight: "Palmenstrände & Karibik-Flair",
    temp: [26,26,27,28,28,28,28,29,28,27,27,26],
  },
];
...
const JSONLD = {
  ...
  "@type": "WebApplication",
  name: "Reisezeit-Finder 2026",
  url: "https://www.urlaubfinder365.de/extras/reisezeit-finder/",
  description: "Finde die beste Reisezeit für dein Wunschziel 2026. Wann wohin reisen? Kostenloser Reisezeit-Finder mit Klimadaten für 15 Top-Destinationen.",
...
export default function ReisezeitFinderPage() {
        ...
        <section className="bg-gradient-to-b from-gray-900 to-gray-950 border-b border-gray-800 py-12 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-black mb-3">
              Reisezeit-Finder <span className="text-[#1db682]">2026</span>
            </h1>
                      ...
                      >
                        ...
                        <div className="flex flex-wrap gap-1 mb-3">
                          ...
                          <span className={`text-[10px] px-2 py-0.5 rounded-full border ${
                            d.budgetStufe === 1 ? "bg-emerald-900/40 border-emerald-700 text-emerald-400"
                            : d.budgetStufe === 2 ? "bg-blue-900/40 border-blue-700 text-blue-400"
