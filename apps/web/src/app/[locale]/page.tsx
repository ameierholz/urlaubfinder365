...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1540541338287-41700207dee6?auto=format&fit=crop&w=1200&h=630&q=70&auto=format",
        width: 1200,
        height: 630,
...
const REISEZIELE_MITTEL_S = [
  { name: "Spanien",     sub: "Mallorca · Teneriffa · Ibiza",     slug: "balearen",         flag: "es", img: "https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=800&q=70&auto=format" },
  { name: "Griechenland",sub: "Kreta · Rhodos · Korfu",           slug: "griechische-inseln",flag: "gr", img: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800&q=70&auto=format" },
    ...
    <>
      ...
      <section className="bg-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-black text-gray-900 mb-6">{t("regionTitleMore")}</h2>
      ...
      {/* Guides, Community, Extras, Magazin, Discovery Hub entfernt — Mobile Performance */}
