...
export const AKTIVITAETEN: Aktivitaet[] = [
  // ── Türkei ──────────────────────────────────────────────────────────
  {
    ...
    foto: "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=800&q=80&auto=format",
    fotos: [
      "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=800&q=80&auto=format",
    ...
    anbieter: {
      slug: "mehmet-k",
      name: "Mehmet K.", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1589561253898-768105ca91a8?w=1200&q=80&auto=format",
  ...
  },
  {
    ...
    foto: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "ahmet-y",
      name: "Ahmet Y.", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200&q=80&auto=format",
  ...
  },
  {
    ...
    foto: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "fatma-s",
      name: "Fatma S.", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80&auto=format",
  ...
  // ── Mallorca ─────────────────────────────────────────────────────────
  {
    ...
    foto: "https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "tomeu-m",
      name: "Tomeu M.", avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=1200&q=80&auto=format",
  ...
  },
  {
    ...
    foto: "https://images.unsplash.com/photo-1516912481808-3406841bd33c?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1516912481808-3406841bd33c?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "julia-w",
      name: "Julia W.", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1516912481808-3406841bd33c?w=1200&q=80&auto=format",
  ...
  // ── Kreta ─────────────────────────────────────────────────────────────
  {
    ...
    foto: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "nikos-p",
      name: "Nikos P.", avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=1200&q=80&auto=format",
  ...
  // ── Dubai ─────────────────────────────────────────────────────────────
  {
    ...
    foto: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "omar-a",
      name: "Omar A.", avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1200&q=80&auto=format",
  ...
  // ── Bali ─────────────────────────────────────────────────────────────
  {
    ...
    foto: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800&q=80&auto=format",
    fotos: ["https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800&q=80&auto=format"],
    ...
    anbieter: {
      slug: "wayan-s",
      name: "Wayan S.", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80&auto=format",
      titelbild: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=1200&q=80&auto=format",
